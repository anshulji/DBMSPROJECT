...
<body>
	...
	<% 
	System.out.print("heey"+request);
	if(request==null)
	{
	 out.println("<form action=\"login\"><input type=\"submit\" value=\"Login\"><form> hi");
				...
				<!-- service -->
					<c:forEach items="${list }" var="ct">
						<div class="col-lg-4 col-md-6 service text-black">
							<li class="list-group-item"><h2><a href="productslist/${ct.cat_id } ">${ct.cat_name}</a> </h2></li>
						</div>
					</c:forEach>
				<!-- service -->
		</div>
