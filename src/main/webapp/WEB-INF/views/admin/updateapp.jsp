...
<div class="col-lg-6" style="width: 100%; margin: 0 auto;">
	<form:form method="post" modelAttribute="app" action="/dbms/admin/updateapp">
            <label for="">date</label>
			<br>
				<form:input path="date" type="text" class="form-control" value="${app.getDateString()}" required="true"/>
			<br>
			<label for="">Start time</label>
			<br>
				<form:input path="start_time" type="text" class="form-control" required="true"/>
			<br>
			<label for="">home or shop</label>
			<br>
				<form:input path="home_or_shop" type="text" class="form-control" required="true"/>
			<br>
			<label for="">Status id</label>
			<br>
				<form:input path="status_id" type="text" class="form-control" required="true"/>
			<br>
			<label for="">Amount</label>
			<br>
				<form:input path="amount" type="text" class="form-control" required="true"/>
			<br>
			<label for="">username</label>
			<br>
				<form:input path="username" type="text" class="form-control" required="true"/>
			<br>
							<form:input path="app_id" type="hidden" value="${appid }" class="form-control" required="true"/>
