...
<div class="col-lg-6" style="width: 100%; margin: 0 auto;">
	<form:form method="post" modelAttribute="service" action="/dbms/admin/addservices">
            <label for="">service name</label>
			<br>
				<form:input path="service_name" type="text" class="form-control" required="true"/>
			<br>
			<label for="">price</label>
			<br>
				<form:input path="price" type="text" class="form-control" required="true"/>
			<br>
